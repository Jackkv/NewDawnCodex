...
1. **Submit Corrections:** Fix errors or outdated information
2. **Add Content:** Write new guides or expand existing ones
3. **Improve Clarity:** Rewrite confusing sections
4. **Add Examples:** Provide helpful examples
5. **Update Information:** Keep content current
...
1. **Clear Description:** Explain your changes
2. **Small Commits:** Make focused changes
3. **Test Locally:** Build docs to check
...
- "Magery" not "Magic skill"
- "Hit Points" or "HP"
- "Britannia" for the world
- "New Dawn" for the server
